...
export function Education() {
  ...
  // Measure distance between each timeline dot and the viewport center to drive a glow factor (0..1)
  useEffect(() => {
    let raf = 0;
    const radius = 160; // px influence radius around the sticky glow
    const update = () => {
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          {/* Timeline line with sticky glowing segment (no central dot) */}
            ...
            {portfolioData.education.map((edu, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Content */} 
                  {/* <div className={`ml-14 md:ml-0 ${isLeft ? 'md:pr-24 md:text-right' : 'md:pl-24'} md:w-5/12`}>
                    <div className="bg-card/80 backdrop-blur-sm border border-card-border rounded-xl md:rounded-2xl p-6 md:p-8 shadow-md hover:shadow-lg transition-shadow hover-elevate"></div> */}
